...
import com.example.data.mapper.toCoursesListDTO
import com.example.domain.entity.Course

class FakeCoursesApi(fakeInitCourses:List<Course>? = null): CoursesApi {

    private val listCourses:CoursesListDTO = fakeInitCourses?.toCoursesListDTO()
        ?: CoursesListDTO(
            listOf(
                CourseDTO(
                    id = 100,
